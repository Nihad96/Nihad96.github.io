...
?>
    <div id="content" class="content_e4">
        <div id="div_creer_destination">
            <button id="bouton_e5_auth" class="bouton" type="button" onclick="window.open('fichiers/e4/e4_7/NZ_E4_7_panier_dynamique.pdf')">Documentation PDF</button>
        </div>
        ...
        <div class="bloc_profil bloc_e4">
           ...
           <br> <p>Ensuite, on affiche en position absolue, en haut à droite de l'icone du panier, un cercle rouge comprenant la quantité d'articles contenue dans la base de données.</p>
            <img class="img_programmes" src="images/e4/e4_7/panier_3.PNG">
        </div>

        <div class="bloc_profil bloc_e4">
            <p>Fichier connexion_panier_navbar.php :</p>
            <img class="img_programmes" src="images/e4/e4_7/panier_4.PNG">

        </div>

        <div class="bloc_profil bloc_e4">
            <p>Panier vide</p>
            <img class="img_programmes" src="images/e4/e4_7/panier_1.PNG">
        </div>
