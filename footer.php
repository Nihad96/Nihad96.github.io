...
<div id="footer_social">
    <div class="social" onclick="window.open(\'https://www.instagram.com/cirtazz/?hl=fr\');">
        <img src="icons/instagram.png" alt="instagram" class="social_img">
        <p>@cirtazz</p>
    </div>
    <div class="social" onclick="window.open(\'https://twitter.com/Nihad_zt\');">
        <img src="icons/twitter.png" alt="twitter" class="social_img">
        <p>@Nihad_zt</p>
    </div>
